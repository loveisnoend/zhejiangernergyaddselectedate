...
// 			    document.getElementById('profitNameAverPersonProfitRecord').innerHTML = document.getElementById('powerPlantMainDetailTitleAverPersonProfitRecord').innerHTML;
//     			var color1 = '#2DE630';
//     			var color2 = '#E52DE6';
//     			var option = {
//     			        title : {
...
//     },
	...
	//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			    // 基于准备好的dom，初始化echarts图表
                myChart4 = ec.init(document.getElementById('powerPlantMapAverPersonProfitRecord'));
				var allAverPersonProfitRecordData = map1Data;			
		        var option4 = {
					...
					series : [
						{
							...
							markPoint : {
								...
								data :allAverPersonProfitRecordData
							},
							geoCoord: {
								// "温州":[120.65,28.01],
								// "义乌":[120.06,29.32],
		...
		///////////////////////////////安徽淮南市地图////////////////////////////////////////////
				...
				var allAverPersonProfitRecordData2 = map2Data;
				option5 = {
					title : {
						text: '',
						subtext: '',
					...
					series : [
						{
							...
							markPoint : {
								...
								data :allAverPersonProfitRecordData2
							},
							geoCoord: {
                                "淮南":[116.73,32.80],
                                "上海":[3000,3000]
