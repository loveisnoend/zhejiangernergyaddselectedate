...
*/
	...
	//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
				...
				myChart4.on(ecConfig.EVENT.CLICK, function (param){  
				    ...
				    document.getElementById('fuelCostNet').innerHTML = mapSeries.markPoint.data[param.dataIndex].inputPlanValue;
				    document.getElementById('fuelDownPercentNet').innerHTML = mapSeries.markPoint.data[param.dataIndex].coalDays;
				    document.getElementById('travelPriceNet').innerHTML = mapSeries.markPoint.data[param.dataIndex].averUsePerH;
				    document.getElementById('coalPriceNet').innerHTML = mapSeries.markPoint.data[param.dataIndex].netPowerWPerH;
				    document.getElementById('coalCostNet').innerHTML = mapSeries.markPoint.data[param.dataIndex].otherAllCost;
				    // document.getElementById('wattVolume1').innerHTML = mapSeries.markPoint.data[param.dataIndex].inputPlanValue;
				    document.getElementById('watt1Net').innerHTML = mapSeries.markPoint.data[param.dataIndex].depreciationCost;
				    // document.getElementById('wattVolume2').innerHTML = mapSeries.markPoint.data[param.dataIndex].peopleCost;
				    document.getElementById('watt2Net').innerHTML = mapSeries.markPoint.data[param.dataIndex].repairCost;
